        ...
        <div class="modal-actions" style="display: flex; flex-direction: column; gap: 15px;">
          <div style="display: flex; flex-direction: column; gap: 8px;">
            ...
            <div style="display: flex; gap: 10px;">
              <button id="openSurveyLinkBtn" class="button-secondary" style="flex: 1;">
                <i class="material-icons">open_in_new</i> Abrir
              </button>
              <button id="copySurveyLinkBtn" class="button-secondary" style="flex: 1;">
          ...
          <div style="display: flex; flex-direction: column; gap: 8px;">
            ...
            <div style="display: flex; gap: 10px;">
              <button id="openAutoSendSurveyLinkBtn" class="button-secondary" style="flex: 1;">
                <i class="material-icons">open_in_new</i> Abrir
              </button>
              <button id="copyAutoSendSurveyLinkBtn" class="button-secondary" style="flex: 1;">
                <i class="material-icons">content_copy</i> Copiar
              </button>
            </div>
          </div>
